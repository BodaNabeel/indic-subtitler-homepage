...
export default function Footer() {
  return (
    <footer className="md:px-20 lg:px-40 px-2 py-12 bg-[#edf2fa] flex md:flex-row flex-col">
      <section>
        <h1 className="text-3xl font-semibold font-sans text-primary-color">
          Indic Subtitler
        </h1>
      ...
      <section className="flex md:flex-row flex-col md:gap-60 text-xl md:mt-0 mt-10 space-y-4 md:space-y-0">
        <div className="">
          <h3 className="font-semibold text-primary-color">Products</h3>
        ...
        <div>
          <h3 className="font-semibold text-primary-color">Company</h3>
          <ul className="text-gray-500 space-y-1">
            <li>Contact</li>
            <li>Terms</li>
            <li>Privacy</li>
